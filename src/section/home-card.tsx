...
export default function HomeCard() {
  ...
  return (
    <div className='flex gap-[24px] mb-[68px] text-white'>
        <Link  href={'/anticorrosive'}  locale={locale} className='group rounded-lg  w-full flex items-start bg-[#1451fa80] gap-8 p-[24px]'>
            ...
            <Image className='aspect-square my-[46px]' src={'/Frame2087326695.png'} width={180} height={180} alt='dsd' title='ds'/>
        </Link>
        <Link  href={'/financing'}  locale={locale} className='group rounded-lg  w-full flex items-start bg-[#1451fa80] gap-8 p-[24px]'>
            <div className='w-full  max-w-[328px]'>
            ...
            <Image className='aspect-square my-[46px]' src={'/image1608.png'} width={180} height={180} alt='dsd' title='ds'/>
        </Link>
    </div>
  )
}
